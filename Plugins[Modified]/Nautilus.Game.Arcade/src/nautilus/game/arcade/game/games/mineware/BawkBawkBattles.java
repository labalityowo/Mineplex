...
import nautilus.game.arcade.game.games.mineware.challenge.type.*;
...
import nautilus.game.arcade.game.games.mineware.tracker.*;
...
public class BawkBawkBattles extends TeamGame implements IThrown
{
	...
	public BawkBawkBattles(ArcadeManager manager)
	{
		...
		registerStatTrackers(new BouncingShadowTracker(this), new DragonKingTracker(this), new EliteArcherTracker(this), new MilkManTracker(this), new PinataMasterTracker(this), new PixelNinjaTracker(this), new SpeedyBuildersTracker(this), new SurfUpTracker(this), new TagMasterTracker(this), new VeteranTracker(this));
	}
